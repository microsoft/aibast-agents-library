...
def audit_html(html: str, contract: dict) -> AuditResult:
    # The shared design-token block is generated by tools/design_tokens.py and
    # pinned by tests/test_design_tokens.py; this gate judges the page's own CSS.
    html = _strip_design_block(html)
    result = AuditResult()

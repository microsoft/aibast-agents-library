# Manual reviewed references and historical film

The current authority is `repaired-r5/browserfilm.json`, a reviewed reference set,
...
`browserfilm.json`, `manual-build-walkthrough.gif`, `manual-build-contact-sheet.jpg`, the old JPEGs and their annotations

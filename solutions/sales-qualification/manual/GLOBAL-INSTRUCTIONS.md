...
- `SQ-01` / `sales-qualification-score-leads`: `Lead Qualification Summary`, `Top Hot Leads`, `Evidence boundary`
- `SQ-02` / `sales-qualification-bant-analysis`: `BANT Analysis`, `Strongest Engagement Signals`, `Evidence boundary`
- `SQ-03` / `sales-qualification-create-outreach`: `Personalized Outreach`, `Draft Sequence Cadence`, `Evidence boundary`
- `SQ-04` / `sales-qualification-assign-leads`: `Recommended Lead Routing`, `Handoff Package`, `Evidence boundary`
- `SQ-05` / `sales-qualification-setup-tracking`: `Draft SLA Tracking Plan`, `Proposed Monitoring`, `Evidence boundary`
- `SQ-06` / `sales-qualification-qualification-report`: `Qualification Report`, `Synthetic Conversion Assumptions`, `Evidence boundary`

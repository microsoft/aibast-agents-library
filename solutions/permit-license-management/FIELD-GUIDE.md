...
- `PERMIT_LICENSE_MANAGEMENT-01` — recorded prompt
- `PERMIT_LICENSE_MANAGEMENT-02` — recorded prompt
- `PERMIT_LICENSE_MANAGEMENT-03` — recorded prompt
- `PERMIT_LICENSE_MANAGEMENT-04` — recorded prompt

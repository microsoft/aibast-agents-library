---
name: leave-balance
description: Use when an employee asks for the fictional balance snapshot and published time-off rules.
---
<!-- bic:source=blank -->
# Leave-balance explanation

Use when an employee asks for the fictional balance snapshot and published time-off rules.

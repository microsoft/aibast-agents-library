---
name: remote-work
description: Use when an employee or manager asks for published remote-work rules without inferring a sensitive circumstance.
---
<!-- bic:source=blank -->
# Remote-work policy guidance

Use when an employee or manager asks for published remote-work rules without inferring a sensitive circumstance.
...
- `Standard Allowance`
- `Requires role, location`
- `Do not infer caregiver`

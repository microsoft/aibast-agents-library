...
| Surface | Location |
| --- | --- |
| Customer field guide | `solutions/ask-hr/FIELD-GUIDE.md` |
...
**Scaffold status:** 71 resources ready; 0 pending. Manual evidence and referenced screenshots passed scaffold validation.

...
Build `patient-intake-source.zip` from the generated manifest:

```text
python3 tools/build_solution_export.py \
  solutions/patient-intake/export-manifest.json
```
...
- Solution ZIP: [`patient-intake-copilot-studio-solution.zip`](patient-intake-copilot-studio-solution.zip)
- Deployment settings: [`patient-intake-deployment-settings.json`](patient-intake-deployment-settings.json)
- Export details: [`patient-intake-solution-export.json`](patient-intake-solution-export.json)

...
description: MUST be used for fictional executive-contact, escalation, billing, or utilization questions before any generic search helper.
---
# Client engagement analysis

Use the packaged portfolio table and exact red-flag list. Report
`Exec meetings (90d)`, `Escalations (90d)`, billing, and utilization as
source-recorded historical values.

For the locked engagement case, preserve these exact findings:

...
| Copilot Studio solution ZIP | `solutions/customer-sentiment-churn/exports/customer-sentiment-churn-copilot-studio-solution.zip` |
| Copilot Studio deployment settings | `solutions/customer-sentiment-churn/exports/customer-sentiment-churn-deployment-settings.json` |
| Copilot Studio export metadata | `solutions/customer-sentiment-churn/exports/customer-sentiment-churn-solution-export.json` |

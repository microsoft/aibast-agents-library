# Customer Sentiment and Churn Prediction Agent — GitHub Copilot Easy mode
...
```text
Give me Customer Sentiment and Churn Prediction using Easy Mode and test it for me.
```

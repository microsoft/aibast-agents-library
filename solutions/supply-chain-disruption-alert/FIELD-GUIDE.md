...
- `SUPPLY_CHAIN_DISRUPTION_ALERT-01` — recorded prompt
- `SUPPLY_CHAIN_DISRUPTION_ALERT-02` — recorded prompt
- `SUPPLY_CHAIN_DISRUPTION_ALERT-03` — recorded prompt
- `SUPPLY_CHAIN_DISRUPTION_ALERT-04` — recorded prompt

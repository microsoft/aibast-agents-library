---
name: proposal-generation-references-positioning
description: Draft reference and competitive positioning options using synthetic evidence only.
---

# Proposal Generation Agent — References Positioning

## Persona
Bid Manager

## Input contract
- Operation: `references_positioning`
...
## Procedure
1. Confirm that the request matches `references_positioning`.
...
4. Produce the exact fixed-snapshot evidence with the required `References & Competitive Positioning`, `Win Theme`, `Evidence boundary` anchors.
...
## Locked demo prompt
Prepare synthetic reference and competitive positioning options for Meridian Healthcare, with availability checks before use.

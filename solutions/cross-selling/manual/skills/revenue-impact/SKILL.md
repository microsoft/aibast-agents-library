---
name: cross-selling-revenue-impact
description: Compare the portfolio's synthetic cross-sell value scenarios without making revenue or margin claims.
---

# Cross-Selling Opportunities Agent — Revenue Impact
...
4. Produce the exact fixed-snapshot evidence with the required `Synthetic Cross-Sell Value Scenario`, `Portfolio Totals`, `Evidence boundary` anchors.

...
```powershell
irm https://cdn.jsdelivr.net/gh/microsoft/aibast-agents-library@main/install.ps1 | iex
```
...
**Mac / Linux:**
```bash
curl -fsSL https://cdn.jsdelivr.net/gh/microsoft/aibast-agents-library@main/community_rapp/install.sh | bash
```

**Windows:**
```powershell
irm https://cdn.jsdelivr.net/gh/microsoft/aibast-agents-library@main/community_rapp/install.ps1 | iex
```

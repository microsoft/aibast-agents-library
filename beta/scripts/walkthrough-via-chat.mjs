...
const prompt = [
  ...
  "- Summon a rappid tile from the public catalog by its seven-word key, and say",
  "  plainly what just happened — a public read, no account and no sign-in, with",
  "  the bytes verified against seed and face before they became anything.",
  ...
  "- Make the summoned tile primary and take one turn with it, so the learner sees",
  "  that a capability fetched from nothing is immediately usable.",
